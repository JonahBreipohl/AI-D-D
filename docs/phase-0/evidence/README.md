...
| [Owner decision log](../08-owner-decision-log.md) | Living log; decisions recorded through 2026-09-23 | Controlling record of owner choices and acceptances | Records the initial defaults, California jurisdiction, base P0-03 acceptance, and Amendment 01 acceptance. It is not participant evidence. |
