...
- **Current desk-only critical path:** Advisory-review and reconcile P0-07 v0.1 without broadening its authority, then reconcile the provisional P0-09 v0.1 consumer to the accepted result. Phase 0 P0-07/P0-09 acceptance remains blocked on the P0-06/P0-05 evidence chain and required named-human/role reviews; executed P1B full-turn evidence is separately required later to finalize or replace the economic gates and ADR-0007/0015 before production integration. Human research is deferred: recruitment and fieldwork remain NO-GO, G0 remains closed, and no Phase 1 production task is authorized.
