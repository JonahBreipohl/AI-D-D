...
- **Next critical path:** Review, repair, and freeze `P0-08-pre` v0.1; independently review and dry-run the matching operator/run-pack materials; complete the separate P0-04 human GO and real interviews; then obtain the stricter P0-05 GO and real prototype evidence. After P0-05, finalize `P0-08-final`. Recruitment and human research remain NO-GO, G0 remains closed, and no Phase 1 production task is authorized.
...
| P0-07 | Define the three resolution lanes: deterministic mechanic, bounded pre-roll ruling, and unsupported/clarify | A1 + A2 | P0-01, P0-03, P0-06 | Examples, inputs, validators, visibility, pre-roll commitment, correction authority, and fallback for each lane accepted |
